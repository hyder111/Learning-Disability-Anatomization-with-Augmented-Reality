...
public class GridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        else if (category.equals("Speech Test"))
        {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent questionIntent = new Intent(parent.getContext(),SpeechActivity.class);
                    questionIntent.putExtra("category",category);
                    questionIntent.putExtra("setNo",position+1);
                    questionIntent.putExtra("finished",finished);
        ...
        ((TextView)view.findViewById(R.id.textview)).setText("Start");
        return view;
    }
}
